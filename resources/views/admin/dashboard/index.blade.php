        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row mb-3 mt-3 align-items-end" id="dashboard-filter-form">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Doanh thu
                                                (Theo bộ
                                                lọc)</div>
                                            <div id="kpi-doanh-thu" class="h5 mb-0 font-weight-bold text-gray-800">Đang
                                                tải...</div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tổng nợ
                                                cần thu
                                            </div>
                                            <div id="kpi-tong-no" class="h5 mb-0 font-weight-bold text-gray-800">Đang tải...
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Số phòng có
                                                hóa đơn
                                            </div>
                                            <div id="kpi-phong-thue" class="h5 mb-0 font-weight-bold text-gray-800">Đang
                                                tải...</div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Hóa đơn
                                                quá hạn</div>
                                            <div id="kpi-hoa-don-qua-han" class="h5 mb-0 font-weight-bold text-gray-800">
                                                Đang tải...
                                            </div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-file-invoice-dollar fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tỷ lệ trạng thái hóa đơn</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-pie pt-4"><canvas id="statusChart"></canvas></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (nhaTroSelect) {
                nhaTroSelect.addEventListener('change', function() {
                    ...
                    const roomUrl = `{{ route('admin.dashboard.getRooms', ['id' => ':id']) }}`.replace(
                        ':id', nhaTroId);
