            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12 d-sm-flex justify-content-between align-items-center">
                        ...
                        @if (auth()->user()->hasPermissionTo('Thêm công tơ nước'))
                            <a href="{{ route('admin.cong_tos.nuoc.create') }}" class="btn btn-success rounded-pill">Thêm
                                công
                                tơ</a>
                        @endif
                    </div>
                    <form method="GET" action="{{ route('admin.cong_tos.nuoc.index') }}" class="row mb-3 align-items-end"
                        id="filter-form">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ route('admin.cong_tos.nuoc.index') }}" class="btn btn-secondary w-100">Xoá lọc</a>
                        </div>
                    </form>
                        ...
                        <table class="table table-striped table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th>Phòng</th>
                                    <th>Nhà trọ</th>
                                    @if (auth()->user()->hasAnyPermission(['Sửa công tơ nước', 'Xóa công tơ nước']))
                                        <th>Hành động</th>
                                    @endif
