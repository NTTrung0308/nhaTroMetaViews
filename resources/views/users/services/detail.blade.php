    ...
    <main class="container my-4">
        <div class="row">
            ...
            <article class="col-lg-8">
                <h2 class="h4">{{ $service->name ?? 'Dịch vụ tư vấn mua bán nhà đất' }}</h2>
                    ...
                    <div class="card-body">
                        ...
                        <form id="serviceContactForm" novalidate>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="ten" name="ten" placeholder="Nhập họ tên" >
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (so_dien_thoai === "") {
                ...
                if (!phoneRegex.test(so_dien_thoai)) {
                    showError(phoneInput, "Số điện thoại không hợp lệ (phải đủ 10 số, bắt đầu bằng 0).");
                    isValid = false;
                }
            }
            if (email === "") {
